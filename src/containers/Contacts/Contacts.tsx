  ...
  return (
    <div className='w-50 mx-auto mt-5 border p-3 rounded text-center'>
      ...
      <p>
        ...
        <span className='ms-4'>г.Бишкек ул.Фрунзе д. 270</span>
      </p>
      <p>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <span className='ms-4'>email: denishrunev@mail.ru</span>
      </p>
      <p>
        ...
        <span className='ms-4'>gmail: deniskhrunev@gmail.com</span>
      </p>
      <p>
        ...
        <a className='ms-4 link-underline-light link-dark' href='tel:+996703740941' >+996(703)740-941</a>
      </p>
    </div>
  );
};
